...
Now we will add columns to the dataset for each USDA broadband program. Each program column will contain a program identifier code for each property that is within the eligibility area for that program. We will create these columns by finding the intersection of the program's eligibility areas (as specified in their respective shapefiles) with the coordinates of the corelogic properties.
